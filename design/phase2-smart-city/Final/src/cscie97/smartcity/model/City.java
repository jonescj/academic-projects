...
public class City {
    ...
    // Create a new device of deviceType if it is valid and does not already exist in the device list.
    public void defineDevice(DeviceType deviceType, String deviceID, Location location, boolean enabled, String vehicleType, String activity, int capacity, int fee) {
        if(deviceType.equals(DeviceType.VEHICLE)){
